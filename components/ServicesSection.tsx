...
const services = [
  ...
  },
  {
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none" aria-hidden="true">
        <rect x="3" y="5" width="16" height="13" rx="2" stroke="#9b5cf6" strokeWidth="1.5"/>
  ...
  },
  {
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none" aria-hidden="true">
        <rect x="4" y="4" width="14" height="14" stroke="#9b5cf6" strokeWidth="1.5"/>
  ...
  },
  {
    ...
    tags: ['Social Templates', 'Presentations', 'Campaign Assets'],
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none" aria-hidden="true">
        <path d="M3 18L8 7l5 7 3-4 3 6" stroke="#9b5cf6" strokeWidth="1.5" strokeLinejoin="round"/>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none" aria-hidden="true">
        <path d="M4 15l4-4 3 3 5-7" stroke="#9b5cf6" strokeWidth="1.5" strokeLinejoin="round"/>
  ...
  },
  {
    ...
    tags: ['Approved Products', 'Controlled Ordering', 'Brand Compliance', 'Team Access', 'Standardized Execution'],
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none" aria-hidden="true">
        <rect x="3" y="3" width="16" height="16" rx="3" stroke="#9b5cf6" strokeWidth="1.5"/>
  ...
  return (
    ...
    >
      <div className="flex justify-between items-end flex-wrap gap-7 mb-[52px]">
        ...
        <p className="rv d1 text-[rgba(24,24,27,0.58)] leading-[1.8]" style={{ fontSize: 'clamp(15px,1.4vw,18px)', maxWidth: '340px' }}>
          Blossom Rocket helps businesses create a complete brand ecosystem that scales across digital and physical experiences.
        </p>
      </div>
      ...
      */}
      ...
      {/* Row 1 — 4 cards */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px bg-[rgba(24,24,27,0.10)]" role="list">
      ...
      {/* Row 2 — 2 cards */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-px bg-[rgba(24,24,27,0.10)] mt-px" role="list">
...
function ServiceCard({ svc, delay }: { svc: typeof services[0]; delay: number }) {
  return (
    ...
    >
      <span className="block text-[12px] font-semibold tracking-[0.1em] mb-[26px] grad-text">{svc.num}</span>
      <div
      ...
      <p className="text-[14px] text-[rgba(24,24,27,0.58)] leading-[1.75] mb-5 flex-1" itemProp="description">
        {svc.desc}
      </p>

...
export default function ContactSection() {
  ...
  return (
    ...
    >
      {/* Orbs */}
      <div className="absolute w-[500px] h-[500px] -top-[150px] -left-[100px] rounded-full pointer-events-none"
        style={{ background: 'radial-gradient(circle,rgba(155,92,246,0.2),transparent 70%)' }} />
      <div className="absolute w-[400px] h-[400px] -bottom-[100px] -right-[80px] rounded-full pointer-events-none"
      ...
      <h2
        ...
        style={{ fontFamily: "'Parkinsans', sans-serif", fontSize: 'clamp(44px,7vw,96px)' }}
      >
        Build A Brand System<br />
      ...
      >
        Create a brand that works consistently across websites, marketing materials, promotional products, apparel, signage, onboarding kits, tradeshow materials, and company stores.
      </p>
      ...
      >
        ...
        <button
          ...
          style={{ background: sent ? 'linear-gradient(90deg,#10b981,#06b6d4)' : 'linear-gradient(90deg,#9b5cf6,#06b6d4)' }}
        >

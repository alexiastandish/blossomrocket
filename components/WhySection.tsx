      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-[clamp(40px,7vw,100px)] items-start">
        ...
        <div className="rv d2 flex flex-col gap-4">
          <div className="bg-[rgba(255,255,255,0.04)] border border-[rgba(255,255,255,0.08)] rounded-2xl p-8">
            ...
            <div className="flex flex-col">
              {outcomes.map((item, i) => (
                ...
                >
                  <div className="w-[18px] h-[18px] rounded-full flex items-center justify-center text-[10px] text-[rgba(239,68,68,0.7)] flex-shrink-0 bg-[rgba(239,68,68,0.15)] border border-[rgba(239,68,68,0.3)]">
                    ✕
                  </div>
                  {item}
                </div>
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg,rgba(155,92,246,0.15),rgba(6,182,212,0.1))",
            }}
          >
            <p className="text-[14px] text-[rgba(255,255,255,0.75)] leading-[1.7]">
              <strong className="text-white">
                A Brand System solves this problem
              </strong>{" "}
              by creating a single source of truth — one centralized framework
              that every team, department, and vendor works from.
            </p>
          </div>
        </div>
      </div>

...
export function CompanyStoresDemoBtn({
  label,
  href,
  theme = "light",
}: {
  ...
  return (
    <button
      aria-label="Book a Company Store demo with Jane Smith, President of SplashBrands"
      type="button"
      className={className}
    >
      <span className="relative z-10">
        Book a Company Store Demo with SplashBrands
      </span>
    </button>
  );
}
